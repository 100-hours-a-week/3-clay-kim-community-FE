...
function createPostCard(post) {
    ...
    const profileImageHtml = `<img src="${escapeHtml(profileImageUrl)}" alt="프로필" class="post-author-profile-image" onerror="this.onerror=null; this.src='${DEFAULT_PROFILE_IMAGE}';">`;
